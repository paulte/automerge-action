...
Use GitHub's **Private Vulnerability Reporting** or **Security Advisories** to report a vulnerability [privately](https://github.com/paulte/automerge-action/security/advisories)
